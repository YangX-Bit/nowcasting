...
# 1. 202424 the whole week is missing
# 2. For 202502 data, some states like SP they didn't update for this week
#    so the week 2025-01-05 is excluded in those state's data  
