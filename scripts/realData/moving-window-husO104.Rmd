...
scoreRange_husO104 <- seq(as.Date("2011-05-27"), as.Date("2011-07-04"),by="12 day")
...
save(out_husO104, file = file.path(path_proj, "data", "fitted_model","husO104_110527_to_110702_four.RData"))
