...
```{r}
scoreRange_SARI <- seq(as.Date("2009-07-15"),as.Date("2009-10-15"),by="30 day")
scoreRange_SARI
...
list_sari_d26
highlight_metrics(list_sari_d26, method_names = c("Constant q", "Constant b", "Random Walk b","OU b"), date_labels = scoreRange_SARI,
