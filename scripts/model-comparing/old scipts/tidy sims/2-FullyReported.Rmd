...
D_trunc <- 15; D_complete <- 20; if_fully_rep <- T
...
data_1$case_true - data_1$case_reported[,16]
...
#save(out_1, file = file.path(path_proj, "data", "fitted_model", "simulation", "FR_b01_sd001.RData"))
...
ggsave(filename = file.path(path_proj, "plots_to_show", "simulation", "FR_b01_sd001.png"), 
...
print(cat(highlight_metrics(fully_tables_1, method_names =c("Fixed q", "Fixed b", "Polynomial b" , "Random Walk b"),
...
#save(out_2, file = file.path(path_proj, "data", "fitted_model", "simulation", "FR_b01_sd01.RData"))
#load(file.path(path_proj, "data", "fitted_model", "simulation", "FR_b01_sd01.RData"))
...
#save(out_3, file = file.path(path_proj, "data", "fitted_model", "simulation", "FR_b01_sd03.RData"))
load(file.path(path_proj, "data", "fitted_model", "simulation", "FR_b01_sd03.RData"))
...
ggsave(filename = file.path(path_proj, "plots_to_show", "simulation", "FR_b01_sd01.png"), 
...
ggsave(filename = file.path(path_proj, "plots_to_show", "simulation", "FR_b01_sd03.png"), 
