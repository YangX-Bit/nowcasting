...
#save(out_list_2_NFR, file = file.path(path_proj, "data", "fitted_model", "simulation", "NotFR_b01_sd01_sims5.RData"))
...
#save(out_list_3_NFR, file = file.path(path_proj, "data", "fitted_model", "simulation", "NotFR_b01_sd03_sims5.RData"))
...
plots_2_NFR <- nowcasts_plot(
  nowcasts_list = results_2_NFR_avg,
  D = D,
  report_unit = "day",
  models_to_run = c("fixed_q", "fixed_b", "linear_b", "ou_b"),
  combine_plots = TRUE,
...
plots_3_NFR <- nowcasts_plot(
  nowcasts_list = results_3_NFR_avg,
  D = D,
  report_unit = "day",
  models_to_run = c("fixed_q", "fixed_b", "linear_b", "ou_b"),
  combine_plots = TRUE,
