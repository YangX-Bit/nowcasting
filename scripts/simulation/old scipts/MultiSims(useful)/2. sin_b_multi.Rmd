...
#load(file.path(data_save_path, "FR_sin_b.RData"))
...
```{r}
highlight_metrics(metrics_1_NFR_avg, method_names = c("Fixed q", "Fixed b", "OU b"),
                  table_caption = "Fully Reported + Low Variability (All Time Window)")
highlight_metrics(metrics_1_sin_b_NFR_avg_incomp, method_names = c("Fixed q", "Fixed b", "Linear b", "OU b"),
                  table_caption = "Fully Reported + Low Variability (Last D Time Unit)")
```
