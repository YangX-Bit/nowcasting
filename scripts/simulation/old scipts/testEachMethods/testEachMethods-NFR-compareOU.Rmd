...
#data path
data_save_path = file.path(path_proj, "data", "fitted_model", "simulation", "NFR_OUcompare")
```
...
save(out_fixed_q_NFR, file = file.path(data_save_path, "NFR_fixed_q_compareOU.RData"))
#load( file.path(data_save_path, "NFR_fixed_q_compareOU.RData"))
# 
...
for (i in 1:length(results_fixed_q_NFR)) {
  print(calculate_metrics(data.table::last(results_fixed_q_NFR[[i]],D),
                          methods = c("withoutInter", "fixedInter", "ouInter", "normInter")))
}
...
save(out_fixed_b_NFR, file = file.path(data_save_path, "NFR_fixed_b_compareOU.RData"))
# load( file.path(data_save_path, "NFR_fixed_b_compareOU.RData"))

results_fixed_b_NFR <- nowcasts_table(out_fixed_b_NFR, D = D, report_unit = "day", 
                          methods = c("withoutInter", "fixedInter", "ouInter", "normInter"))

plots_fixed_b_NFR <- nowcasts_plot(results_fixed_b_NFR, D = D, report_unit = "day", methods = c("withoutInter", "fixedInter", "ouInter", "normInter"))
...
for (i in 1:length(results_fixed_b_NFR)) {
  print(calculate_metrics(data.table::last(results_fixed_b_NFR[[i]],D),
                          methods = c("withoutInter", "fixedInter", "ouInter", "normInter")))
}
...
save(out_rw_b_NFR, file = file.path(data_save_path, "NFR_rw_b_compareOU.RData"))
#load( file.path(data_save_path, "NFR_rw_b_compareOU.RData"))

results_rw_b_NFR <- nowcasts_table(out_rw_b_NFR, D = D, report_unit = "day", 
                          methods = c("withoutInter", "fixedInter", "ouInter", "normInter"))

plots_rw_b_NFR <- nowcasts_plot(results_rw_b_NFR, D = D, report_unit = "day", methods = c("withoutInter", "fixedInter", "ouInter", "normInter"))
...
for (i in 1:length(results_rw_b_NFR)) {
  print(calculate_metrics(data.table::last(results_rw_b_NFR[[i]],D),
                          methods = c("withoutInter", "fixedInter", "ouInter", "normInter")))
}
...
save(out_ou_b_NFR, file = file.path(data_save_path, "NFR_ou_b_compareOU.RData"))
#load(file.path(data_save_path, "NFR_ou_b_compareOU.RData"))

results_ou_b_NFR <- nowcasts_table(out_ou_b_NFR, D = D, report_unit = "day", 
                          methods = c("withoutInter", "fixedInter", "ouInter", "normInter"))

plots_ou_b_NFR <- nowcasts_plot(results_ou_b_NFR, D = D, report_unit = "day", methods = c("withoutInter", "fixedInter", "ouInter", "normInter"))
...
for (i in 1:length(results_ou_b_NFR)) {
  print(calculate_metrics(data.table::last(results_ou_b_NFR[[i]],D),
                          methods = c("withoutInter", "fixedInter", "ouInter", "normInter")))
}
