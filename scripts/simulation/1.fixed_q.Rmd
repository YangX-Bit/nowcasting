...
#data path
data_save_path = file.path(path_proj, "data", "fitted_model", "simulation", "1. fixed_q")
```
...
## fit model
```{r}
out_fixed_q_FR <- nowcasting_moving_window(fixed_q_FR$case_reported_cumulated, scoreRange =  as.Date("2024-02-12"),
...
```{r}
out_fixed_q_NFR <- nowcasting_moving_window(fixed_q_NFR$case_reported_cumulated, scoreRange = as.Date("2024-02-12"),
