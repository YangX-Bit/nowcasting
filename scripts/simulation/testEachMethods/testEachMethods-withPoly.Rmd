...
params_linear_b_FR <- list(
  ...
  q_model = list(
    method        = "linear_b",
    method_params = list(beta0 = -2, beta1 = 0.05, phi_init = 0.2, phi_sigma = 0.05)
  )
)
...
params_ou_b_FR <- list(
  ...
  q_model = list(
    method        = "ou_b",
    method_params = list(alpha = 0.8, mu = 0.1, b_init = 0.1, b_sigma = 0.1 , phi_init = 0.2, phi_sigma = 0.05)
  )
)
