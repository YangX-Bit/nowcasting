...
## fit model
```{r}
out_1_FR <- nowcasting_moving_window(NFR_1$case_reported, scoreRange = scoreRange, 
...
```{r}
out_2_FR <- nowcasting_moving_window(NFR_2$case_reported, scoreRange = scoreRange, 
...
```{r}
out_3_FR <- nowcasting_moving_window(NFR_3$case_reported, scoreRange = as.Date("2024-02-15"), 
