...
#save(out_list_1_NFR, file = file.path(path_proj, "data", "fitted_model", "simulation_ou", "NotFR_b01_sd001_sims5.RData"))
...
#save(out_list_2_NFR, file = file.path(path_proj, "data", "fitted_model", "simulation_ou", "NotFR_b01_sd01_sims5.RData"))
#load(file.path(path_proj,"data", "fitted_model", "simulation", "NotFR_b01_sd001.RData"))
...
time_1 <- Sys.time() - time_1_s

save(out_list_3_NFR, file = file.path(path_proj, "data", "fitted_model", "simulation_ou", "NotFR_b01_sd03_sims5.RData"))
#load(file.path(path_proj,"data", "fitted_model", "simulation", "NotFR_b01_sd001.RData"))
