...
n_obs = 60
# reprot structure
D_trunc <- 10; D_complete <- 20; if_fully_reported <- F
# model
method = "ou"; 
...
results_1_NFR <- nowcasts_table(out_1_NFR, D = D_trunc, report_unit = "day", 
                          models_to_run = c("fixed_q", "fixed_b", "linear_b", "ou_b"))

results_1_NFR_plots <- nowcasts_plot(results_1_NFR, D = D_trunc, report_unit = "day", models_to_run = c("fixed_q", "fixed_b", "linear_b" , "ou_b"))
...
results_2_NFR <- nowcasts_table(out_2_NFR, D = D_trunc, report_unit = "day", 
                          models_to_run = c("fixed_q", "fixed_b", "linear_b", "ou_b"))

results_2_NFR_plots <- nowcasts_plot(results_2_NFR, D = D_trunc, report_unit = "day", models_to_run = c("fixed_q", "fixed_b", "linear_b" , "ou_b"))
``` 
...
results_3_NFR <- nowcasts_table(out_3_NFR, D = D_trunc, report_unit = "day", 
                          models_to_run = c("fixed_q", "fixed_b", "linear_b", "ou_b"))

results_3_NFR_plots <- nowcasts_plot(results_3_NFR, D = D_trunc, report_unit = "day", models_to_run = c("fixed_q", "fixed_b", "linear_b" , "ou_b"))
...
# Within D
for(i in 1:length(results_1_NFR)){
  print(calculate_metrics(data.table::last(results_1_NFR[[i]], D_trunc)))
}
```
...
# Within D
for(i in 1:length(results_2_NFR)){
  print(calculate_metrics(data.table::last(results_2_NFR[[i]], D_trunc)))
}
```
...
# Within D
for(i in 1:length(results_3_NFR)){
  print(calculate_metrics(data.table::last(results_3_NFR[[i]], D_trunc)))
}
```
...
# output
```{r}
results_1_NFR_plots <- nowcasts_plot(results_1_NFR, D = D_trunc, report_unit = "day",
                                 models_to_run = c("fixed_q", "fixed_b", "linear_b" , "ou_b"),
...
# output
```{r}
results_2_NFR_plots <- nowcasts_plot(results_2_NFR, D = D_trunc, report_unit = "day",
                                 models_to_run = c("fixed_q", "fixed_b", "linear_b" , "ou_b"),
                                 combine_plots = T, ncol = 2
                                 )
...
```{r}
results_3_NFR_plots <- nowcasts_plot(results_3_NFR, D = D_trunc, report_unit = "day",
                                 models_to_run = c("fixed_q", "fixed_b", "linear_b" , "ou_b"),
                                 combine_plots = T, ncol = 2
                                 )
