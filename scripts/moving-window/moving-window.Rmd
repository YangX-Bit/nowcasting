...
# generate alpha
alpha_lambda <- generate_alpha(N_obs, range = c(40, 200), dist = "uniform", seed = 123)
...
selected_dates <- dates[c(10,20,30,40)]  # pick certain days

nowcasting_moving_window(data$case_reported, selected_dates,
